...
satelites_stationsFiLaXYZ_path = str(Path(__file__).parent.parent) + "\\gen_data\\" + station_file_id + "_stationsFiLaXYZ.txt"
...
satelites_distance14XYZ_path = str(Path(__file__).parent.parent) + "\\gen_data\\" + sat_file_id + "_distance14XYZ.txt"
satellite_visibility_path = str(Path(__file__).parent.parent) + "\\gen_data\\" + sat_file_id + "_visibility_satellite.txt"
